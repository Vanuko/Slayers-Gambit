// src/data/heroItems.ts
import type { Item } from '@/utils/inventory'

export const heroItemsMap: Record<string, Item[]> = {
  Young_Blood: [
    {
      slot: 'Chest',
      name: `Guy's Plate`,
      ...
      skill: [
        {
          ...
          requirements: [{ type: 'Agility', score: 4 }],
          block: 6,
        },
      ],
      resistances: [
    ...
    },
    {
      ...
      skill: [
        {
          name: 'Flail Swing',
          requirements: [{ type: 'Strength', score: 4 }],
          damageMin: 2,
          damageMax: 8,
        },
      ],
    },
    {
      ...
      skill: [
        {
          name: 'Shield Block',
          requirements: [{ type: 'Agility', score: 3 }],
          block: 4,
        },
        {
          name: 'Shield Bash',
    ...
    },
    {
      ...
      skill: [
        {
          name: 'Dodge',
          requirements: [{ type: 'Agility', score: 6 }],
          dodge: 1,
        },
      ],
    },
